...
**Dotted line:** estimated density of the null genes ($\hat\pi_0$, read off the flat region) — the central quantity in Storey's adaptive FDR control (next sub-section) and in Efron's two-groups model (Lecture 2).
...
|----------|:---:|---------|
| No correction | Thousands | Hundreds of false positives — Caspi-style |
...
**Theorem** ([Benjamini & Hochberg, 1995](https://doi.org/10.1111/j.2517-6161.1995.tb02031.x)). Under independence of the test statistics,
...
$$\hat\pi_0(\lambda) = \frac{\#\{p_i > \lambda\}}{m(1-\lambda)}, \qquad \text{typically } \lambda = 0.5.$$
