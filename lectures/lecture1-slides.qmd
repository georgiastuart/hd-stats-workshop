...
![](images/pval-histogram-pathologies.png){fig-alt="Storey & Tibshirani (2003) Figure 1: p-value histogram from the Hedenfalk breast cancer dataset; dashed line at the uniform-null density, dotted line at the estimated null proportion" width="55%"}

**Dashed line:** density if all genes were null (uniform; height = 1).
**Dotted line:** estimated density of the null genes ($\hat\pi_0$, read off the flat region) — the central quantity in FDR estimation, developed in Lecture 2.
